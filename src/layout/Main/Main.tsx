...
export function Main() {
    ...
    function changeTaskTitle(idTDL: string, idTask: string, newTtile: string) {
        setTasks({
            ...tasks,
            [idTDL]: tasks[idTDL].map((el) =>
                el.id === idTask ? { ...el, title: newTtile } : el
            ),
        });
    }

    function changeTodolistTitle(idTDL: string, newTtile: string) {
        setTodolists(
            todolists.map((tdl) =>
                tdl.id === idTDL ? { ...tdl, title: newTtile } : tdl
            )
        );
    }
